        ...
        public override void Execute(int userId, bool hasReceivedArguments, string arguments = "")
        {
            ...
            else
            {
                if (input == 1)
                {
                    ...
                    ChatCommandManager.SendDebugMsgFormatted(DebugMsgType.INFO, "fast reload enabled");
                }
                else
                {
                    Game.EnableHotReload(false);
                    ChatCommandManager.SendDebugMsgFormatted(DebugMsgType.INFO, "fast reload disabled");
                }
