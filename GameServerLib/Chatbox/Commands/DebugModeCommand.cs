...
namespace LeagueSandbox.GameServer.Chatbox.Commands
{
    public class DebugParticlesCommand : ChatCommandBase
    {
        ...
        public void DebugSelf(int userId)
        {
            ...
            _logger.Debug($"started debugging self, your debug circle Radius is" + "(1 / 100) * " + _userChampion.CollisionRadius + " = " + "(" + (1f / 100f) + ") * " + _userChampion.CollisionRadius + " = " + circlesize);
            var startdebugmsg = $"started debugging self, your debug circle radius is  " + "(1 / 100) * " + _userChampion.CollisionRadius + " = " + "(" + (1f / 100f) + ") * " + _userChampion.CollisionRadius + " = " + circlesize;
