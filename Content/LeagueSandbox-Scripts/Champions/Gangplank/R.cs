...
namespace Spells
{
    public class CannonBarrage : ISpellScript
    {
        ...
        public void OnSpellPreCast(IObjAiBase owner, ISpell spell, IAttackableUnit target, Vector2 start, Vector2 end)
        {
            ...
            var particle = AddParticlePos(owner, "pirate_cannonBarrage_aoe_indicator_green.troy", spellPos, spellPos, lifetime: 7.0f, teamOnly: owner.Team);
            var particlered = AddParticlePos(owner, "pirate_cannonBarrage_aoe_indicator_red.troy", spellPos, spellPos, lifetime: 7.0f, teamOnly: CustomConvert.GetEnemyTeam(owner.Team));
            var i = 1.0f;
            while (i <= 7.0f)
            {
                CreateTimer(i, () =>
