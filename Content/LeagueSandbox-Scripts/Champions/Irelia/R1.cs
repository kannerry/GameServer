...
namespace Spells
{
    public class IreliaTranscendentBlades : ISpellScript
    {
        ...
        public void OnSpellCast(ISpell spell)
        {
            ...
            AddParticleTarget(owner, owner, "Irelia_ult_dagger_active_01.troy", owner, bone: "l_shoulder");
        }
        ...
        public void OnSpellPostCast(ISpell spell)
        {
            ...
            spell.CastInfo.Owner.SetSpell("IreliaTranscendentBladesSpell", 3, true);
