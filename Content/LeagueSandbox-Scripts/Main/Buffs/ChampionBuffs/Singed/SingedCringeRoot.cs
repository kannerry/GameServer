...
namespace Buffs
{
    internal class SingedCringeRoot : IBuffGameScript
    {
        ...
        public void OnActivate(IAttackableUnit unit, IBuff buff, ISpell ownerSpell)
        {
            ...
            buff1 = AddParticleTarget(caster, unit, "Singed_Base_W_Root_Feet.troy", unit);
            buff2 = AddParticleTarget(caster, unit, "Singed_Base_W_Root.troy", unit);
