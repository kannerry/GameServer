...
{
    public class ItemID_3155 : IItemScript
    {
        ...
        private void TargetExecute(IAttackableUnit unit1, IAttackableUnit unit2)
        {
            if(unit1.Stats.CurrentHealth < unit1.Stats.HealthPoints.Total * 0.3f)
            {
                ...
                {
                    timer = true;
                    unit1champ.ApplyShield(unit1, 250, false, true, false);
                    CreateTimer(5.0f, () => { unit1champ.ApplyShield(unit1, -250, false, true, false); });
