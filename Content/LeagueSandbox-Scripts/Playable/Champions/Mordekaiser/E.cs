...
namespace Spells
{
    public class MordekaiserSyphonOfDestruction : ISpellScript
    {
        ...
        public void TargetExecute(ISpell spell, IAttackableUnit target, ISpellMissile missile, ISpellSector sector)
        {
            ...
            AddParticleTarget(owner, target, "mordakaiser_siphonOfDestruction_tar_02.troy", target);
            AddParticleTarget(owner, target, "mordakaiser_siphonOfDestruction_tar.troy", target);
            AddParticleTarget(owner, owner, "mordakaiser_siphonOfDestruction_self.troy", owner);
