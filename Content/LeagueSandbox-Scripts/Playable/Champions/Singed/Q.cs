...
namespace Spells
{
    public class PoisonTrail : ISpellScript
    {
        ...
        public void OnSpellPostCast(ISpell spell)
        {
            ...
            if (owner.HasBuff("SingedQToggleBuff"))
            {
                owner.RemoveBuffsWithName("SingedQToggleBuff");
            }
            else
            {
                thisBuff = AddBuff("SingedQToggleBuff", 25000.0f, 1, spell, owner, owner);
            }
        }
