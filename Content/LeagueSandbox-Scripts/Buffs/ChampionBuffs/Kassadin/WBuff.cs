    ...
    internal class NetherBlade : IBuffGameScript
    {
        ...
        public void OnActivate(IAttackableUnit unit, IBuff buff, ISpell ownerSpell)
        {
            ...
            if (unit is IObjAiBase ai)
            {
                ...
                p = AddParticleTarget(ownerSpell.CastInfo.Owner, ownerSpell.CastInfo.Owner, "Kassadin_Base_W_buf.troy", unit, buff.Duration, 1, "R_hand", "R_hand");
                p2 = AddParticleTarget(ownerSpell.CastInfo.Owner, ownerSpell.CastInfo.Owner, "Kassadin_Netherblade.troy", unit, buff.Duration, 1, "R_hand", "R_hand");
