...
namespace Buffs
{
    internal class Mana_Regeneration : IBuffGameScript
    {
        ...
        public void OnActivate(IAttackableUnit unit, IBuff buff, ISpell ownerSpell)
        {
            ...
            potion = AddParticleTarget(caster, unit, "GLOBAL_Item_ManaPotion.troy", unit, buff.Duration, bone: "Buffbone_Glb_Ground_Loc");
        }
